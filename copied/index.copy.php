...
<head>
    <meta name="description" content="Web word processing, spreadsheets and presentations">
    <meta name="viewport"
    ...
    <link href="//fonts.googleapis.com/css?family=Product+Sans" rel="stylesheet" type="text/css"
        nonce="OEaoySBATJcbZhw0jRFMsQ"> -->
    <style nonce="OEaoySBATJcbZhw0jRFMsQ">
    ...
    <style type="text/css" nonce="OEaoySBATJcbZhw0jRFMsQ">
        body {
    ...
    <div id="outerContainer">
        <div id="innerContainer">
            <div style="position: absolute; top: -80px;">
                <div id="drive-logo"><a href="/"><span class="docs-drivelogo-img" title="Google logo"></span><span
                            class="docs-drivelogo-text">&nbsp;Drive</span></a></div>
            </div>
            <div align="center">
                <p class="errorMessage" style="padding-top: 50px">Sorry, unable to open the file at present.</p>
                <p> Please check the address and try again.</p>
                <div
                    style="background: #F0F6FF; border: 1px solid black; margin-top: 35px; padding: 10px 125px; width: 300px;">
